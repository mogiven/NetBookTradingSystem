<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyAccount.aspx.cs" Inherits="BookTradingSystem.MyAccount" %>
  ...
  <!--<![endif]-->
    ...
    <div class="sidebar-nav">
        ...
        <ul id="accounts-menu" class="nav nav-list collapse in">
            <li class="active"><a href="MyAccount.aspx">我的账号</a></li>
        </ul>
        <%=m_ManagerMenu %>
    </div>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <form runat="server">
                    ...
                    <asp:Button ID="btnSave" runat="server" Text="保存" class="btn btn-primary pull-right" OnClick="btnSave_Click"/>
