...
{
    public partial class MyStar : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string table_data = "<table class=\"table table-bordered table-striped\">" +
                ...
                "<tbody>";
            //foreach (var dat in data_list.Where(n => n.TransactionType == (int)BookInfoTransactionType.Star).OrderByDescending(n => n.BookInfoId))
            //{
            ...
            //        $"<a href=\"MyStar.aspx?action=del&id={dat.BookInfoId}\"><i class=\"icon-remove\"></i></a>" +
            //        $"</td>";
            //}
