<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Purchase.aspx.cs" Inherits="BookTradingSystem.Purchase" %>
  ...
  <!--<![endif]-->
    ...
    <div class="sidebar-nav">
        ...
        <ul id="dashboard-menu" class="nav nav-list collapse in">
            ...
            <li class="active"><a href="Purchase.aspx">求购信息</a></li>
        </ul>
...
<div class="btn-toolbar">
    <a class="btn btn-primary" href="MyBookInfo.aspx?action=p"><i class="icon-plus"></i>发布新信息</a>
  <div class="btn-group">
  </div>
</div>
